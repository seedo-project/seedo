...
public class SendChatMessageService {
     ...
     *
     * <p>"이만 정리할게요" 트리거가 자동인지 수동인지는 별도 작업 — 이 프롬프트는 그 시점까지의 대화를
     * 5가지 정보 중심으로 끌고 가는 데만 집중. 충분히 모였다고 판단되면 마무리 멘트를 함께 던진다.
     */
    static final String SYSTEM_PROMPT = """
            ...
            - 5가지 필수 정보가 충분히 모였다고 판단되면 간단한 마무리 멘트를 던지세요
              (예: "충분히 이야기 나눴어요. 정리해볼게요.").
